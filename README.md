...
作为项目核心成员，完成了用户设备信息的收集并限制单设备登录，优化慢接口响应至200ms内，并基于Zookeeper和SofaRPC实现了跨服务调用，封装了Redis工具库、JSR303参数校验注解以及一个简单ORM映射库。

##### 2. 脑学家生活小程序

##### 3. 脑学家数据可视化

作为项目负责人，选择使用Gradle构建项目，完成了对前端埋点数据的收集，并可视化数据，给决策层提供产品充足的优化空间，提供用户满意度和留存率。
